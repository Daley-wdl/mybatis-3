...
public class JavassistProxyFactory implements org.apache.ibatis.executor.loader.ProxyFactory {
    ...
    private static final Log log = LogFactory.getLog(org.apache.ibatis.executor.loader.javassist.JavassistProxyFactory.class);
                ...
                synchronized (lazyLoader) {
                    ...
                    if (WRITE_REPLACE_METHOD.equals(methodName)) {
                        ...
                        if (lazyLoader.size() > 0) {
                            return new org.apache.ibatis.executor.loader.javassist.JavassistSerialStateHolder(original, lazyLoader.getProperties(), objectFactory, constructorArgTypes, constructorArgs);
                        } else {
                            return original;
                        }
                    } else {
    ...
    private static class EnhancedDeserializationProxyImpl extends AbstractEnhancedDeserializationProxy implements MethodHandler {
        ...
        protected AbstractSerialStateHolder newSerialStateHolder(Object userBean, Map<String, ResultLoaderMap.LoadPair> unloadedProperties, ObjectFactory objectFactory,
                                                                 List<Class<?>> constructorArgTypes, List<Object> constructorArgs) {
            return new org.apache.ibatis.executor.loader.javassist.JavassistSerialStateHolder(userBean, unloadedProperties, objectFactory, constructorArgTypes, constructorArgs);
        }
    }
}
