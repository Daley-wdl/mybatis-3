...
public class MetaClass {
    ...
    public static org.apache.ibatis.reflection.MetaClass forClass(Class<?> type, ReflectorFactory reflectorFactory) {
        return new org.apache.ibatis.reflection.MetaClass(type, reflectorFactory);
    }
     ...
     * @return MetaClass 对象
     */
    public org.apache.ibatis.reflection.MetaClass metaClassForProperty(String name) {
        // 获得属性的类
        Class<?> propType = reflector.getGetterType(name);
        // 创建 MetaClass 对象
        return org.apache.ibatis.reflection.MetaClass.forClass(propType, reflectorFactory);
    }
    ...
    public Class<?> getSetterType(String name) {
        ...
        if (prop.hasNext()) {
            org.apache.ibatis.reflection.MetaClass metaProp = metaClassForProperty(prop.getName());
    ...
    public Class<?> getGetterType(String name) {
        ...
        if (prop.hasNext()) {
            // 创建 MetaClass 对象
            org.apache.ibatis.reflection.MetaClass metaProp = metaClassForProperty(prop);
    ...
    private org.apache.ibatis.reflection.MetaClass metaClassForProperty(PropertyTokenizer prop) {
    ...
    private StringBuilder buildProperty(String name, StringBuilder builder) {
        ...
        if (prop.hasNext()) {
            ...
            if (propertyName != null) {
                ...
                builder.append(".");
                // 创建 MetaClass 对象
                org.apache.ibatis.reflection.MetaClass metaProp = metaClassForProperty(propertyName);
