...
public class ResolverUtil<T> {
     ...
     */
    private static final Log log = LogFactory.getLog(org.apache.ibatis.io.ResolverUtil.class);
     ...
     */
    public org.apache.ibatis.io.ResolverUtil<T> findImplementations(Class<?> parent, String... packageNames) {
     ...
     * @param packageNames one or more package names to scan (including subpackages) for classes
     */
    public org.apache.ibatis.io.ResolverUtil<T> findAnnotated(Class<? extends Annotation> annotation, String... packageNames) {
        if (packageNames == null) {
            return this;
        }
     ...
     */
    public org.apache.ibatis.io.ResolverUtil<T> find(Test test, String packageName) {
        // 获得包的路径
